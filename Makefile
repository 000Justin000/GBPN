...
run_pubmed:
	...
	python main.py --dataset PubMed --split 0.6 0.2 0.2 --model BPGNN --learning_rate 1.0e-2 --device cuda
...
run_coauthor_cs:
	...
	python main.py --dataset Coauthor_CS --split 0.6 0.2 0.2 --model BPGNN --learning_rate 1.0e-2 --device cuda
...
run_coauthor_physics:
	...
	python main.py --dataset Coauthor_Physics --split 0.6 0.2 0.2 --model BPGNN --learning_rate 1.0e-2 --device cuda
...
run_county_facebook:
	...
	python main.py --dataset County_Facebook --split 0.6 0.2 0.2 --model BPGNN --learning_rate 1.0e-2 --device cuda
