...
run_Products:
	...
	python main.py --dataset OGBN_Products                            --model_name GBPN --dim_hidden 256 --num_layers 2 --num_hops 2 --num_samples 20 --dropout_p 0.1 --learning_rate 1.0e-3 --num_epoches 100 --num_trials  3 --device $(device) --learn_H          --verbose
	python main.py --dataset OGBN_Products                            --model_name GBPN --dim_hidden 256 --num_layers 2 --num_hops 2 --num_samples 20 --dropout_p 0.1 --learning_rate 1.0e-3 --num_epoches 100 --num_trials  3 --device $(device) --learn_H --eval_C --verbose
