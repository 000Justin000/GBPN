...
run_Animals:
	python main.py --dataset Animals --homo_ratio 0.0 --split 0.6 0.2 0.2 --model_name MLP   --learning_rate 1.0e-2 --device cuda --num_hidden 2
	...
	python main.py --dataset Animals --homo_ratio 0.0 --split 0.6 0.2 0.2 --model_name GAT   --learning_rate 1.0e-3 --device cuda
	python main.py --dataset Animals --homo_ratio 0.1 --split 0.6 0.2 0.2 --model_name GAT   --learning_rate 1.0e-3 --device cuda
	python main.py --dataset Animals --homo_ratio 0.2 --split 0.6 0.2 0.2 --model_name GAT   --learning_rate 1.0e-3 --device cuda
	python main.py --dataset Animals --homo_ratio 0.3 --split 0.6 0.2 0.2 --model_name GAT   --learning_rate 1.0e-3 --device cuda
	python main.py --dataset Animals --homo_ratio 0.4 --split 0.6 0.2 0.2 --model_name GAT   --learning_rate 1.0e-3 --device cuda
	python main.py --dataset Animals --homo_ratio 0.5 --split 0.6 0.2 0.2 --model_name GAT   --learning_rate 1.0e-3 --device cuda
	python main.py --dataset Animals --homo_ratio 0.6 --split 0.6 0.2 0.2 --model_name GAT   --learning_rate 1.0e-3 --device cuda
	python main.py --dataset Animals --homo_ratio 0.7 --split 0.6 0.2 0.2 --model_name GAT   --learning_rate 1.0e-3 --device cuda
	python main.py --dataset Animals --homo_ratio 0.8 --split 0.6 0.2 0.2 --model_name GAT   --learning_rate 1.0e-3 --device cuda
	python main.py --dataset Animals --homo_ratio 0.9 --split 0.6 0.2 0.2 --model_name GAT   --learning_rate 1.0e-3 --device cuda
	python main.py --dataset Animals --homo_ratio 1.0 --split 0.6 0.2 0.2 --model_name GAT   --learning_rate 1.0e-3 --device cuda
	python main.py --dataset Animals --homo_ratio 0.0 --split 0.6 0.2 0.2 --model_name BPGNN --learning_rate 1.0e-2 --device cuda --num_hidden 1
	python main.py --dataset Animals --homo_ratio 0.1 --split 0.6 0.2 0.2 --model_name BPGNN --learning_rate 1.0e-2 --device cuda --num_hidden 1
	python main.py --dataset Animals --homo_ratio 0.2 --split 0.6 0.2 0.2 --model_name BPGNN --learning_rate 1.0e-2 --device cuda --num_hidden 1
	python main.py --dataset Animals --homo_ratio 0.3 --split 0.6 0.2 0.2 --model_name BPGNN --learning_rate 1.0e-2 --device cuda --num_hidden 1
	python main.py --dataset Animals --homo_ratio 0.4 --split 0.6 0.2 0.2 --model_name BPGNN --learning_rate 1.0e-2 --device cuda --num_hidden 1
	python main.py --dataset Animals --homo_ratio 0.5 --split 0.6 0.2 0.2 --model_name BPGNN --learning_rate 1.0e-2 --device cuda --num_hidden 1
	python main.py --dataset Animals --homo_ratio 0.6 --split 0.6 0.2 0.2 --model_name BPGNN --learning_rate 1.0e-2 --device cuda --num_hidden 1
	python main.py --dataset Animals --homo_ratio 0.7 --split 0.6 0.2 0.2 --model_name BPGNN --learning_rate 1.0e-2 --device cuda --num_hidden 1
	python main.py --dataset Animals --homo_ratio 0.8 --split 0.6 0.2 0.2 --model_name BPGNN --learning_rate 1.0e-2 --device cuda --num_hidden 1
	python main.py --dataset Animals --homo_ratio 0.9 --split 0.6 0.2 0.2 --model_name BPGNN --learning_rate 1.0e-2 --device cuda --num_hidden 1
	python main.py --dataset Animals --homo_ratio 1.0 --split 0.6 0.2 0.2 --model_name BPGNN --learning_rate 1.0e-2 --device cuda --num_hidden 1
