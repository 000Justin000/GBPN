...
On a high level, a GBPN first compute the initial prediction on each node using its features (with a MLP), then runs belief propagation to iteratively correct the predictions.
