...
On a high level, a GBPN first computes the initial label prediction for each node using its features (with a MLP), then runs belief propagation to iteratively correct the predictions.
