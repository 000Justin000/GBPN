...
python main.py --dataset OGBN_Products --model_name SAGE --dim_hidden 256 --num_hidden 2 --dropout_p 0.1 --learning_rate 1.0e-2 --num_epoches  30 --num_trials 3 --device cuda:0                                  --verbose &
...
python main.py --dataset OGBN_Products --model_name GBPN --dim_hidden 256 --num_hidden 2 --dropout_p 0.1 --learning_rate 1.0e-2 --num_epoches  30 --num_trials 3 --device cuda:2 --weighted_BP --learn_H --eval_C --verbose &
